...
const getAllStudentsFromDb = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield model_student_1.StudentModel.find(whereConditions)
      ...
      .skip(skip)
      .limit(limit);
    const total = yield model_student_1.StudentModel.countDocuments(
      whereConditions
    );
    return {
      meta: {
...
const getSingleStudentFromDb = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield model_student_1.StudentModel.findOne({ id })
      .populate('academicSemester')
      .populate('academicDepartment')
      .populate('academicFaculty');
    return result;
...
const updateStudentFromDb = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield model_student_1.StudentModel.findOne({ id });
    if (!isExist) {
  ...
  */
    ...
    const result = yield model_student_1.StudentModel.findOneAndUpdate(
      { id },
      updatedStudentData,
      {
        new: true,
...
const deleteStudentFromDb = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield model_student_1.StudentModel.findByIdAndDelete(id)
      .populate('academicSemester')
      .populate('academicDepartment')
      .populate('academicFaculty');
    return result;

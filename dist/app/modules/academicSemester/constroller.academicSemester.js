...
const createAcademicSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield service_academicSemester_1.AcademicSemesterService.createAcademicSemesterByDb(
        academicData
      );
...
const getAllAcademicSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    //****************search and filter start******* */
    // export const ACADEMIC_SEMESTER_FILTERABLE_FIELDS=['searchTerm', 'year', 'code', 'title']
    const filters = (0, pick_1.default)(
      req.query,
      consent_academicSemester_1.ACADEMIC_SEMESTER_FILTERABLE_FIELDS
    );
    //****************pagination start************ */
    ...
    const result =
      yield service_academicSemester_1.AcademicSemesterService.getAllAcademicSemesterFromDb(
        filters,
        paginationOptions
      );
    (0, sendResponse_1.default)(res, {
...
const getSingleAcademicSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    ...
    const result =
      yield service_academicSemester_1.AcademicSemesterService.getSignleSemesterFromDb(
        id
      );
    /* if (!result) {
...
const updateAcademicSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    ...
    const result =
      yield service_academicSemester_1.AcademicSemesterService.updateSemesterFromDb(
        id,
        updateData
      );
    /* if (!result) {
...
const deleteAcademicSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield service_academicSemester_1.AcademicSemesterService.deleteSemesterByIdFromDb(
        id
      );
    (0, sendResponse_1.default)(res, {
      success: true,

...
const createAcademicDepartment = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield service_academicDepartment_1.AcademicDepartmentService.createAcademicDepartmentByDb(
        academicData
      );
...
const getAllAcademicDepartment = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const filters = (0, pick_1.default)(
      req.query,
      consent_academicDepartment_1.ACADEMIC_DEPARTMENT_FILTERABLE_FIELDS
    );
    //****************pagination start************ */
    ...
    const result =
      yield service_academicDepartment_1.AcademicDepartmentService.getAllAcademicDepartmentFromDb(
        filters,
        paginationOptions
      );
    (0, sendResponse_1.default)(res, {
...
const getSingleAcademicDepartment = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield service_academicDepartment_1.AcademicDepartmentService.getSignleDepartmentFromDb(
        id
      );
    /* if (!result) {
...
const updateAcademicDepartment = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield service_academicDepartment_1.AcademicDepartmentService.updateDepartmentFromDb(
        id,
        updateData
      );
    /* if (!result) {
...
const deleteAcademicDepartment = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield service_academicDepartment_1.AcademicDepartmentService.deleteDepartmentByIdFromDb(
        id
      );
    (0, sendResponse_1.default)(res, {
      success: true,
